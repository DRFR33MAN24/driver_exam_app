...
public class LoadProfile extends AsyncTask<String, String, String> {
    ...
    private String success = "0", message = "", userId = "", userName = "", userEmail = "",userIdNum="", userPhone = "", userGender = "", profileImage = "";
    ...
    protected String doInBackground(String... strings) {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                userIdNum = c.getString("user_id_num");
    ...
    protected void onPostExecute(String s) {
        profileListener.onEnd(s, success, message, userId, userName, userEmail,userIdNum, userPhone, userGender, profileImage);
