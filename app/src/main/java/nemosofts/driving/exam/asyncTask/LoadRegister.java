...
public class LoadRegister extends AsyncTask<String, String, String> {
    ...
    private String user_id = "", user_name = "", email = "",id_num="", auth_id = "";
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if(c.has("user_id")) {
                    ...
                    id_num = c.getString("user_id_num");
                }
            }
            return "1";
        } catch (Exception e) {
    ...
    protected void onPostExecute(String s) {
        socialLoginListener.onEnd(s, success, message, user_id, user_name, email,id_num, auth_id);
