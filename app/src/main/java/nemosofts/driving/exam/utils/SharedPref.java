...
public class SharedPref {
    ...
    public void setLoginDetails(String id, String name, String mobile,String id_num, String email, String gender, @NonNull String profilePic, String authID, Boolean isRemember, String password, String loginType) {
        ...
        editor.putString(TAG_ID_NUM, encryptData.encrypt(id_num));
    ...
    public String getIdNumber() {
        return encryptData.decrypt(sharedPreferences.getString(TAG_ID_NUM,""));
    }
