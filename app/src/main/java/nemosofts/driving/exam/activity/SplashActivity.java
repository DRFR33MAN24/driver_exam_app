...
import nemosofts.driving.exam.ProSplashActivity;
import nemosofts.driving.exam.asyncTask.LoadProduct;
                ...
                public void onEnd(String success, String loginSuccess, String message, String user_id, String user_name, String user_gender, String user_phone, String profile_img) {
                    ...
                    if (success.equals("1")) {
                        if (!loginSuccess.equals("-1")) {
                            sharedPref.setLoginDetails(user_id, user_name, user_phone,sharedPref.getIdNumber(), sharedPref.getEmail(), user_gender, profile_img, authID, sharedPref.getIsRemember(), sharedPref.getPassword(), loginType);
                            sharedPref.setIsLogged(true);
                        }
                    }
                    openMainActivity();
                }
            }, helper.callAPI(Callback.METHOD_LOGIN, 0,"","","","","","",sharedPref.getIdNumber(),"","","",sharedPref.getPassword(),authID,loginType,null));
            loadLogin.execute();
        } else {
            errorDialog(getString(R.string.error_internet_not_connected), getString(R.string.error_try_internet_connected));
        }
