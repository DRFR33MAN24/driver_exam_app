...
import nemosofts.driving.exam.asyncTask.LoadStatus;
...
import nemosofts.driving.exam.interfaces.ProfileListener;
...
public class ProfileActivity extends ProCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_id = findViewById(R.id.tv_profile_id);
    ...
    private void loadUserProfile() {
        if (helper.isNetworkAvailable()) {
            LoadProfile loadProfile = new LoadProfile(new ProfileListener() {
                ...
                @Override
                public void onEnd(String success, String isApiSuccess, String message, String user_id, String user_name, String email,String userIdNum, String mobile, String gender, String profile) {
                    progressDialog.dismiss();
                    if (success.equals("1")) {
                        if (isApiSuccess.equals("1")) {
                            sharedPref.setUserName(user_name);
                            sharedPref.setEmail(email);
                            sharedPref.setIDNum(userIdNum);
    ...
    public void setVariables() {
        ...
        textView_id.setText(sharedPref.getIdNumber());
